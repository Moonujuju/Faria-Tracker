  ...
  return (
    <div style={{
      ...
      <div style={{ maxWidth: 1020, margin: "0 auto" }}>
        ...
        {page === "ai" && <TrackerPage title="AI Initiatives" subtitle="Features, projects, and integrations across Faria products" storageKey="faria-ai-v11" sortField="product" defaults={DEFAULT_AI} ModalComponent={AIModal} onCelebrate={setCelName} addLabel="+ AI Initiative"
